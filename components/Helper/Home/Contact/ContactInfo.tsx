  ...
  return (
    <div>
      <div className='flex items-center space-x-8'>
        ...
        <div>
            <h1 className='text-lg sm:-xl text-white font-bold'>Phone</h1>
      ...
      <div className='flex items-center space-x-8 mt-8 mb-8'>
        ...
        <div>
            <h1 className='text-lg sm:-xl text-white font-bold'>Email Address</h1>
      ...
      <div className='flex items-center space-x-8 mt-8 mb-8'>
        ...
        <div>
            <h1 className='text-lg sm:-xl text-white font-bold'>Address</h1>
